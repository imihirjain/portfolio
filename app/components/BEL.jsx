  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {experienceData.bel.company}{" "}
          <span className="text-sm font-semibold italic">
            {experienceData.bel.location}
          </span>
        </motion.h2>

        <p className="mb-1 max-w-3xl text-sm sm:text-base text-gray-600 font-fira font-bold">
          {experienceData.bel.department}
        </p>
        <p className="mb-5 max-w-3xl text-sm sm:text-base text-gray-600 font-ovo font-black">
          {experienceData.bel.role} |{" "}
          {experienceData.bel.duration}
        </p>
        ...
        >
          {experienceData.bel.responsibilities.map((item, index) => (
            <motion.li
              key={index}
              variants={{
